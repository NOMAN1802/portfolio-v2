    ...
    <div className="fixed w-full h-[400px] z-50 flex justify-center
     pointer-events-none bg-transparent">
        ...
        {showMenu && showMenuButton && (
            ...
            bottom-[42rem] xl:bottom-[32rem]  px-4 pointer-events-auto">
        ...
        className="bg-accent shadow-custom w-[54px]h-[54px] rounded-lg cursor-pointer
                ...
                <AnimatePresence>
                    {showMenuButton && (
                        ...
                        <motion.div 
                         ...
                         >
                         <button onClick={()=> setShowMenu(!showMenu)} 
                         className="bg-accent shadow-custom w-[54px]
                         h-[54px] rounded-lg cursor-pointer flex items-center

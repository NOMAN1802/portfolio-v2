    ...
    <section className="h-[800px] relative bg-accent/10 xl:bg-white" id="home">
      ...
      <div className="container mx-auto h-full">
        ...
        ">
          ...
          <TypeAnimation preRenderFirstString={true} sequence={["Websites" , 2000,
            "Apps", 2000]}
           speed={50}
           repeat={Infinity}
           wrapper="span"
          ...
          <p className="lead max-w-[476px] mb-7">Delivering Powerful, custom websites that blend aesthetics with 
            performance.
          </p>
        ...
        <div className="hidden xl:flex w-[55vw] h-[800px] absolute top-0 right-0
        bg-accent
        ">

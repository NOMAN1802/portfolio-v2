...
import { FaLink, FaCalendarAlt, FaTag, FaUser, FaEnvelope, FaEye, FaCopy, FaCheck, FaTimes, FaArrowLeft, FaHome, FaExternalLinkAlt } from 'react-icons/fa';
        ...
        <div className="relative z-10 flex items-center justify-center h-full px-4 lg:px-6">
          <div className="text-center text-white max-w-5xl">
            ...
            <div className="inline-flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-semibold uppercase tracking-wider">{post?.category}</span>
            </div>
            ...
            <p className="text-xl lg:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-8 font-light">
              Dive deep into this insightful article and discover valuable knowledge, 
              expert insights, and practical tips that will enhance your understanding.
            </p>
            ...
            <div className="flex items-center justify-center space-x-8 mt-12 text-white/80">
              ...
              <div className="text-center">
                <span className="text-lg font-medium">Blog Article</span>
              </div>
              <div className="w-2 h-2 bg-white/40 rounded-full"></div>
              <div className="text-center">
                <span className="text-lg font-medium">Expert Insights</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div 
              ...
              dangerouslySetInnerHTML={{ __html: sanitizedPostDetails }}
            ></div>
          </div>
        </div>

        {/* Author and Post Details - Side by Side */}
            ...
            <div className="flex items-start space-x-4">
              ...
              <div className="flex-1 space-y-3">
                ...
                <p className="text-gray-600 text-sm leading-relaxed mt-3">
                  Full-stack developer and tech writer passionate about sharing knowledge 
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-between items-center py-3 border-b border-gray-100">
                ...
                <span className="text-gray-900 font-semibold">Blog Article</span>
              </div>
